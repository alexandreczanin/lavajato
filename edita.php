...
<html lang="pt-br">
    ...
    <body>
        ...
        <header>
            <center><img src="imagens/logo.png" width="30%" height="30%"/></center>
            <nav class="navbar navbar-expand-lg navbar-ligth bg-ligth">
                <div class="container-fluid">
                    <h3><b> </b></h3>
                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#exampleModal">Inserir Cliente</button>
                </div>
            </nav>
        </header>
        <div class="container-fluid">
                        ...
                        <div class="card mb-2 rounded-2 shadow-sm">
                            ...
                            <form action="editar.php?id=<?php echo $id; ?>" method="POST">
                                <div class="form-group col-7">
                                    ...
                                    <br/>
                                    <label>Celular:</label>
                                    <input type="text" class="form-control" name="email" value="<?php echo $celular; ?>" required/>
                                    <br/>
                                    <label>Placa</label>
                                    <input type="text" class="form-control" name="celular" value="<?php echo $placa; ?>" required/>
                                    <br/>
                                    <label>Cidade</label>
                                    ...
                                    <br/>
                                    <button type="submit" class="btn btn-outline-dark">Atualizar Cliente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-outline-dark" href="index.php" role="button">Voltar</a>
                                </form>
                                </div>
                            </div>
                        </div>
